...
#      offline in seeded test mode (OpenGovernmentPortalSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "OpenGovernmentPortal_sdk.rb")
  SDK_CLASS = "OpenGovernmentPortalSDK"
  ...
  SDK_BASE = "OpenGovernmentPortal_sdk"
