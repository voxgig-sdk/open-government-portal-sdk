...
The Ruby SDK for the OpenGovernmentPortal API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.OpenGovernmentPortal(nil).load(
  { "id" => "test01" }, nil
)
