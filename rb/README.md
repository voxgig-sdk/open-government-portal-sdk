# OpenGovernmentPortal Ruby SDK



The Ruby SDK for the OpenGovernmentPortal API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `OpenGovernmentPortalError` (a `StandardError` subclass), so wrap
...
```
rb/
├── OpenGovernmentPortal_sdk.rb       -- Main SDK module
...
The main module (`OpenGovernmentPortal_sdk`) exports the SDK class
