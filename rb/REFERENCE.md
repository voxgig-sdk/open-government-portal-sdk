# OpenGovernmentPortal Ruby SDK Reference

Complete API reference for the OpenGovernmentPortal Ruby SDK.
...
#### `OpenGovernmentPortalSDK.test(testopts = nil, sdkopts = nil)`
