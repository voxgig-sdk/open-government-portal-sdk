# OpenGovernmentPortal Python SDK Reference

Complete API reference for the OpenGovernmentPortal Python SDK.
...
#### `OpenGovernmentPortalSDK.test(testopts=None, sdkopts=None)`
