# OpenGovernmentPortal Python SDK



The Python SDK for the OpenGovernmentPortal API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/open-government-portal-sdk/releases)) or
...
```
py/
├── opengovernmentportal_sdk.py         -- Main SDK module
