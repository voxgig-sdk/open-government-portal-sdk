...
The Python SDK for the OpenGovernmentPortal API. Provides an entity-oriented interface following Pythonic conventions.
...
result, err = client.OpenGovernmentPortal(None).load(
    {"id": "test01"}, None
)
