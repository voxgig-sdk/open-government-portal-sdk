# OpenGovernmentPortal SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from opengovernmentportal_sdk import OpenGovernmentPortalSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"OpenGovernmentPortalSDK": OpenGovernmentPortalSDK, "os": os}
        try:
