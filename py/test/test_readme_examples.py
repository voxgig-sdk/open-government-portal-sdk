# OpenGovernmentPortal SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OpenGovernmentPortalSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OpenGovernmentPortalSDK(...) and OpenGovernmentPortalSDK.test(...) become
#      OpenGovernmentPortalSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "opengovernmentportal_sdk"
_SDK_CLASS = "OpenGovernmentPortalSDK"
