...
from opengovernmentportal_sdk.utility import register

# Load features
from opengovernmentportal_sdk.feature.base_feature import OpenGovernmentPortalBaseFeature
from opengovernmentportal_sdk.features import _has_feature, _make_feature
...
class OpenGovernmentPortalSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = OpenGovernmentPortalUtility()
    ...
    def get_utility(self):
        return OpenGovernmentPortalUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OpenGovernmentPortalSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Dataset(self, data=None) -> "DatasetEntity":
        ...
        from opengovernmentportal_sdk.entity.dataset_entity import DatasetEntity
        return DatasetEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "OpenGovernmentPortalSDK":
        if sdkopts is None:
            sdkopts = {}
