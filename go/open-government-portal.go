...
// instead of `sdk.NewOpenGovernmentPortalSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *OpenGovernmentPortalSDK  { return NewOpenGovernmentPortalSDK(nil) }
func Test() *OpenGovernmentPortalSDK { return TestSDK(nil, nil) }
