# OpenGovernmentPortal Golang SDK



The Golang SDK for the OpenGovernmentPortal API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/open-government-portal-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/open-government-portal-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/open-government-portal-sdk/go=../open-government-portal-sdk/go
```
...
```
OPEN_GOVERNMENT_PORTAL_TEST_LIVE=TRUE
```
...
### NewOpenGovernmentPortalSDK

```go
func NewOpenGovernmentPortalSDK(options map[string]any) *OpenGovernmentPortalSDK
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *OpenGovernmentPortalSDK
```
...
| `Dataset` | `(data map[string]any) OpenGovernmentPortalEntity` | Create a Dataset entity instance. |

### Entity interface (OpenGovernmentPortalEntity)

All entities implement the `OpenGovernmentPortalEntity` interface.
...
```
github.com/voxgig-sdk/open-government-portal-sdk/go/
├── open-government-portal.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/open-government-portal-sdk/go`) re-exports everything needed
