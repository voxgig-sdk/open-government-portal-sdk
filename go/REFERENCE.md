# OpenGovernmentPortal Golang SDK Reference

Complete API reference for the OpenGovernmentPortal Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *OpenGovernmentPortalSDK`
...
#### `Dataset(data map[string]any) OpenGovernmentPortalEntity`
