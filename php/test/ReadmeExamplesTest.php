...
// OpenGovernmentPortal SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OpenGovernmentPortalSDK::test)
...
{
    private const SDK_CLASS = 'OpenGovernmentPortalSDK';
    ...
    private const SDK_BASE = 'opengovernmentportal_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../opengovernmentportal_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
