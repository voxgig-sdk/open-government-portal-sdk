...
class OpenGovernmentPortalTestRunner
{
    ...
    {
        $live = self::getenv('OPENGOVERNMENTPORTAL_TEST_LIVE');
        $override = self::getenv('OPENGOVERNMENTPORTAL_TEST_OVERRIDE');
        ...
        $explain = self::getenv('OPENGOVERNMENTPORTAL_TEST_EXPLAIN');
