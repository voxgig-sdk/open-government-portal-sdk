...
// OpenGovernmentPortal SDK utility: graphql
//
...
class OpenGovernmentPortalGraphql
{
    ...
    // equivalent.
    public static function body(OpenGovernmentPortalContext $ctx): mixed
    {
    ...
    public static function errors(OpenGovernmentPortalContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
