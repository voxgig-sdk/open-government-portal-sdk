...
// OpenGovernmentPortal SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class OpenGovernmentPortalMakeRequest
{
    public static function call(OpenGovernmentPortalContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new OpenGovernmentPortalResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new OpenGovernmentPortalResponse($fetched);
        } else {
