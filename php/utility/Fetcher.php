...
// OpenGovernmentPortal SDK utility: fetcher

class OpenGovernmentPortalFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OpenGovernmentPortalSDK/1.0)';
    ...
    public static function call(OpenGovernmentPortalContext $ctx, string $fullurl, array $fetchdef): array
    {
