...
// OpenGovernmentPortal SDK utility: result_basic

class OpenGovernmentPortalResultBasic
{
    public static function call(OpenGovernmentPortalContext $ctx): ?OpenGovernmentPortalResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof OpenGovernmentPortalError) ? $result->err->msg : (string)$result->err;
