...
// OpenGovernmentPortal SDK utility: make_options

class OpenGovernmentPortalMakeOptions
{
    ...
    public static function call(OpenGovernmentPortalContext $ctx): array
    {
        ...
        //
        // `OpenGovernmentPortalSchema::optspec()` is built from the model:
        ...
        $optspec = OpenGovernmentPortalSchema::optspec();
