# OpenGovernmentPortal PHP SDK Reference

Complete API reference for the OpenGovernmentPortal PHP SDK.
...
#### `OpenGovernmentPortalSDK::test($testopts = null, $sdkopts = null)`
...
#### `get_utility(): OpenGovernmentPortalUtility`
...
| `resources` | `array` | No | List of resources associated with the dataset |
