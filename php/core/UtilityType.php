...
// OpenGovernmentPortal SDK utility type

class OpenGovernmentPortalUtility
{
    ...
    public static function copy(OpenGovernmentPortalUtility $src): OpenGovernmentPortalUtility
    {
        $u = new OpenGovernmentPortalUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
