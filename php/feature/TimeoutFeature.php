...
// OpenGovernmentPortal SDK timeout feature
...
class OpenGovernmentPortalTimeoutFeature extends OpenGovernmentPortalBaseFeature
{
    ...
    private function _with_timeout(OpenGovernmentPortalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OpenGovernmentPortalContext $_ctx, float $ms): void
    {
        $client = $this->client;
