...
// OpenGovernmentPortal SDK rbac feature
...
class OpenGovernmentPortalRbacFeature extends OpenGovernmentPortalBaseFeature
{
    ...
    private function _required(OpenGovernmentPortalContext $ctx): ?string
    {
    ...
    private function _reject(OpenGovernmentPortalContext $ctx, string $required): void
    {
    ...
    private function _track(OpenGovernmentPortalContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
