...
// OpenGovernmentPortal SDK audit feature
...
class OpenGovernmentPortalAuditFeature extends OpenGovernmentPortalBaseFeature
{
    ...
    private function _emit(OpenGovernmentPortalContext $ctx, string $outcome): void
    {
