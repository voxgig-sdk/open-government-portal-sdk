...
// OpenGovernmentPortal SDK netsim feature
...
class OpenGovernmentPortalNetsimFeature extends OpenGovernmentPortalBaseFeature
{
    ...
    private function _simulate(OpenGovernmentPortalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(OpenGovernmentPortalContext $ctx, array $applied): void
    {
        $client = $this->client;
