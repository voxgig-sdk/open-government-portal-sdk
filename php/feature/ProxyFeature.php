...
// OpenGovernmentPortal SDK proxy feature
...
class OpenGovernmentPortalProxyFeature extends OpenGovernmentPortalBaseFeature
{
    ...
    public function init(OpenGovernmentPortalContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OpenGovernmentPortalContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
