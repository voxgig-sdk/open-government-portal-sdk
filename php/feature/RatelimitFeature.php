...
// OpenGovernmentPortal SDK ratelimit feature
...
class OpenGovernmentPortalRatelimitFeature extends OpenGovernmentPortalBaseFeature
{
    ...
    private function _acquire(OpenGovernmentPortalContext $ctx): void
    {
    ...
    private function _track(OpenGovernmentPortalContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
