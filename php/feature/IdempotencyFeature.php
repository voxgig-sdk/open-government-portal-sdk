...
// OpenGovernmentPortal SDK idempotency feature
...
class OpenGovernmentPortalIdempotencyFeature extends OpenGovernmentPortalBaseFeature
{
    ...
    private function _mutating(OpenGovernmentPortalContext $ctx): bool
    {
