...
// OpenGovernmentPortal SDK telemetry feature
...
class OpenGovernmentPortalTelemetryFeature extends OpenGovernmentPortalBaseFeature
{
    ...
    private function _close(OpenGovernmentPortalContext $ctx, bool $ok): void
    {
