...
// OpenGovernmentPortal SDK clienttrack feature
...
class OpenGovernmentPortalClienttrackFeature extends OpenGovernmentPortalBaseFeature
{
    ...
    public function PostConstruct(OpenGovernmentPortalContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'OpenGovernmentPortal-SDK';
