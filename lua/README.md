...
The Lua SDK for the OpenGovernmentPortal API. Provides an entity-oriented interface using Lua conventions.
...
local result, err = client:OpenGovernmentPortal(nil):load(
  { id = "test01" }, nil
)
