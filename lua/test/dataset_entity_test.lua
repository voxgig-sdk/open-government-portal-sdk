...
describe("DatasetEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set OPEN_GOVERNMENT_PORTAL_TEST_DATASET_ENTID JSON to run live")
      return
    end
...
function dataset_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("OPEN_GOVERNMENT_PORTAL_TEST_DATASET_ENTID")
  ...
  if env["OPEN_GOVERNMENT_PORTAL_TEST_LIVE"] == "TRUE" then
  ...
  local live = env["OPEN_GOVERNMENT_PORTAL_TEST_LIVE"] == "TRUE"
  return {
    client = client,
    data = entity_data,
