# OpenGovernmentPortal Lua SDK Reference

Complete API reference for the OpenGovernmentPortal Lua SDK.
...
| `resources` | `table` | No | List of resources associated with the dataset |
