...
func registerTools(server *mcp.Server, client *sdk.OpenGovernmentPortalSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "open-government-portal_list",
		Description: "List records from OpenGovernmentPortal. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "open-government-portal_load",
		Description: "Load a single record from OpenGovernmentPortal. " +
...
func runOp(client *sdk.OpenGovernmentPortalSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.OpenGovernmentPortalSDK, name string) (sdk.OpenGovernmentPortalEntity, error) {
