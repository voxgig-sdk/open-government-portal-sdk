# OpenGovernmentPortal TypeScript SDK Reference

Complete API reference for the OpenGovernmentPortal TypeScript SDK.
...
```ts
new OpenGovernmentPortalSDK(options?: object)
```
...
#### `OpenGovernmentPortalSDK.test(testopts?, sdkopts?)`
...
**Returns:** `OpenGovernmentPortalSDK` instance in test mode.
...
Alias for `OpenGovernmentPortalSDK.test()`.
...
Return the parent `OpenGovernmentPortalSDK` instance.
