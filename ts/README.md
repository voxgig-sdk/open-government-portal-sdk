...
The TypeScript SDK for the OpenGovernmentPortal API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new OpenGovernmentPortalSDK({ apikey: '...' })
