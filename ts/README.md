# OpenGovernmentPortal TypeScript SDK



The TypeScript SDK for the OpenGovernmentPortal API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/open-government-portal-sdk/releases](https://github.com/voxgig-sdk/open-government-portal-sdk/releases)
...
```ts
new OpenGovernmentPortalSDK(options?: {
  base?: string
  prefix?: string
  suffix?: string
...
| `tester(testopts?, sdkopts?)` | `OpenGovernmentPortalSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `OpenGovernmentPortalSDK.test(testopts?, sdkopts?)` | `OpenGovernmentPortalSDK` | Create a test-mode client. |
...
| `client` | `client(): OpenGovernmentPortalSDK` | Return the parent SDK client. |
...
├── src/
│   ├── OpenGovernmentPortalSDK.ts        # Main SDK class
