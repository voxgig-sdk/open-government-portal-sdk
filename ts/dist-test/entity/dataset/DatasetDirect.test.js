...
(0, node_test_1.describe)('DatasetDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.OpenGovernmentPortalSDK({
...
function liveScenariosActive() { return false && process.env.OPEN_GOVERNMENT_PORTAL_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.OpenGovernmentPortalSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['OPEN_GOVERNMENT_PORTAL_TEST_DATASET_ENTID'];
    ...
    const client = new __1.OpenGovernmentPortalSDK({
        base: 'http://localhost:8080',
