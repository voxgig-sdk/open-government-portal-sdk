...
function envOverride(m) {
    if ('TRUE' === process.env.OPEN_GOVERNMENT_PORTAL_TEST_LIVE ||
        'TRUE' === process.env.OPEN_GOVERNMENT_PORTAL_TEST_OVERRIDE) {
    ...
    m.OPEN_GOVERNMENT_PORTAL_TEST_EXPLAIN = process.env.OPEN_GOVERNMENT_PORTAL_TEST_EXPLAIN || m.OPEN_GOVERNMENT_PORTAL_TEST_EXPLAIN;
    return m;
}
