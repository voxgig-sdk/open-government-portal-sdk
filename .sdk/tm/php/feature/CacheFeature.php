...
// OpenGovernmentPortal SDK cache feature
...
class OpenGovernmentPortalCacheFeature extends OpenGovernmentPortalBaseFeature
{
    ...
    private function _through(OpenGovernmentPortalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
