...
// OpenGovernmentPortal SDK metrics feature
...
class OpenGovernmentPortalMetricsFeature extends OpenGovernmentPortalBaseFeature
{
    ...
    private function _record(OpenGovernmentPortalContext $ctx, bool $ok): void
    {
