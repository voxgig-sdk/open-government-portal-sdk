...
// OpenGovernmentPortal SDK streaming feature
...
class OpenGovernmentPortalStreamingFeature extends OpenGovernmentPortalBaseFeature
{
    ...
    private function _iterate(OpenGovernmentPortalResult $result): \Generator
    {
    ...
    private function _streamable(OpenGovernmentPortalContext $ctx): bool
    {
