...
from projectname_sdk import OpenGovernmentPortalSDK
from projectname_sdk.core.spec import OpenGovernmentPortalSpec
from projectname_sdk.core.result import OpenGovernmentPortalResult
from projectname_sdk.core.response import OpenGovernmentPortalResponse
from projectname_sdk.core.operation import OpenGovernmentPortalOperation
from projectname_sdk.core.error import OpenGovernmentPortalError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import OpenGovernmentPortalBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return OpenGovernmentPortalError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except OpenGovernmentPortalError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = OpenGovernmentPortalResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = OpenGovernmentPortalSDK.test(None, None)
        ...
        class TestInitFeature(OpenGovernmentPortalBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(OpenGovernmentPortalBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = OpenGovernmentPortalSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = OpenGovernmentPortalSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_fetch_def_basic(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = OpenGovernmentPortalSpec({
            "base": "http://localhost:8080",
            "prefix": "/api",
            "path": "items/{id}",
            "suffix": "",
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = OpenGovernmentPortalSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = OpenGovernmentPortalSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = OpenGovernmentPortalOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = OpenGovernmentPortalSDK.test(None, setup_opts)
