# OpenGovernmentPortal SDK feature corpus test
#
...
def _client(kase):
    ...
    OpenGovernmentPortalSDK(...), not OpenGovernmentPortalSDK.test(...): the `test` feature is
    ...
    return OpenGovernmentPortalSDK(opts)
