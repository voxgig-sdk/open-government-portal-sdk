...
|---|---|---|
| `ts/` | @voxgig-sdk/open-government-portal-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/open-government-portal-sdk \
      --repository voxgig-sdk/open-government-portal-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/open-government-portal-sdk` shows it, and
`npm trust revoke @voxgig-sdk/open-government-portal-sdk --id=<id>` removes it.
