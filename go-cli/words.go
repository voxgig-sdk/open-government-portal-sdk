...
func registerSDKWords(r *eng.Registry, client *sdk.OpenGovernmentPortalSDK) {
...
func runOp(client *sdk.OpenGovernmentPortalSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
