// Command OpenGovernmentPortal-cli is a CLI + REPL for the OpenGovernmentPortal SDK,
...
const prompt = "open-government-portal"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      OPEN_GOVERNMENT_PORTAL_APIKEY (api key), OPEN_GOVERNMENT_PORTAL_BASE (base url override)")
